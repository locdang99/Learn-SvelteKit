...
>
  ...
  >
    <h4
      class="text-2xl sm:text-3xl md:text-4xl max-w-[1000px] w-full font-medium relative pr-10 after:absolute after:top-full after:left-0 after:w-1/5 after:h-1.5 after:bg-slate-900"
    >
      <slot />
    </h4>
  ...
  <div class={"flex flex-col dropShadow overflow-hidden rounded-b-lg "}>
    ...
    <div class="flex flex-col bg-white gap-4 flex-1">
      <img src={productFeature.imgUrl} alt="image" />
    </div>
  </div>
</div>
